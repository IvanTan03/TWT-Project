...
<head>
    ...
    <link rel="stylesheet" href="css/exercise4-8.css">
...
<div class="back-button" onclick="window.history.back()">
    ...
    <div class="container">
        <div class="question" id="question1">
            <div class="border-box">
                ...
                <img src="./Image/sphere.png" alt="sphere" class="shape">
                <button class="answer" data-answer="sphere">sphere</button>
                <button class="answer" data-answer="cube">cube</button>
                <button id="done-button" class="done-button">Done</button>
            </div>
        </div>
        ...
        <div class="question" id="question2" style="display: none;">
            <div class="border-box">
                <p>What shape is this?</p>
                <img src="./Image/cube.png" alt="cube" class="shape">
                <button class="answer" data-answer="cylinder">cylinder</button>
                <button class="answer" data-answer="cube">cube</button>
                <button id="done-button" class="done-button">Done</button>
            </div>
        </div>
        ...
        <div class="question" id="question3" style="display: none;">
            <div class="border-box">
                <p>What shape is this?</p>
                <img src="./Image/pyramid.png" alt="pyramid" class="shape">
                <button class="answer" data-answer="cone">cone</button>
                <button class="answer" data-answer="pyramid">pyramid</button>
                <button id="done-button" class="done-button">Done</button>
            </div>
        </div>
    </div>
    ...
    <script src="Java Script/exercise4-8.js"></script>
</body>
</html>
