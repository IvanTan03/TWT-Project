...
<head>
    ...
    <title>Numzoo</title>
    <link rel="stylesheet" href="css/exercise5-5.css">
...
<div id="question1" class="question container">
        <h2>Which number is larger?</h2>
        <div class="option" onclick="checkAnswer(1, 4)">
    ...
    <div id="question2" class="question container" style="display:none;">
        <h2>Which number is larger?</h2>
        <div class="option" onclick="checkAnswer(2, 5)">
    ...
    <div id="question3" class="question container" style="display:none;">
        <h2>Which number is larger?</h2>
        <div class="option" onclick="checkAnswer(3, 6)">
            <div class="circle">4</div>
        </div>
        <div class="option" onclick="checkAnswer(3, 6)">
    ...
    <script src="Java Script/exercise5-5.js"></script>
</body>
</html>
