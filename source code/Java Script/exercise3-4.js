...
document.addEventListener('DOMContentLoaded', function () {
    const questions = [
        { text: 'Which shape is a triangle?', correct: './Image/triangle.png', options: ['./Image/triangle.png', './Image/circle.png'] },
        { text: 'Which shape is a circle?', correct: './Image/circle.png', options: ['./Image/square.png', './Image/circle.png'] },
        { text: 'Which shape is a square?', correct: './Image/square.png', options: ['./Image/triangle.png', './Image/square.png'] }
    ];
