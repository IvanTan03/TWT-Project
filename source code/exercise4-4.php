...
<head>
    ...
    <link rel="stylesheet" href="css/exercise4-4.css">
...
<div class="container">
    ...
    <h2>Complete the counting. Drag numbers to their correct places.</h2>
        <div class="question">
            <div class="apples">
                ...
                <div class="apple-container">
                    <div class="apple"></div>
                    <div class="numbers">
                    <div class="dropzone" data-number="15"></div>
                    </div>
                </div>
                <div class="apple-container">
                    <div class="apple"></div>
                ...
                <div class="apple-container">
                    <div class="apple"></div>
                    <div class="numbers">
                    <div class="dropzone" data-number="17"></div>
                    </div>
                </div>
                <div class="apple-container">
                    <div class="apple"></div>
        ...
        <div class="choices">
            ...
            <div class="draggable" draggable="true">17</div>
        ...
        <div class="question">
            <div class="apples">
                ...
                <div class="apple-container">
                    <div class="apple"></div>
                    <div class="numbers">
                    <div class="dropzone" data-number="12"></div>
                    </div>
                </div>
                <div class="apple-container">
                    <div class="apple"></div>
    ...
    <h2>Complete the counting. Drag numbers to their correct places.</h2>
        <div class="question">
            <div class="apples">
                ...
                <div class="apple-container">
                    <div class="apple"></div>
                    <div class="numbers">
                    <div class="dropzone" data-number="16"></div>
                    </div>
                </div>
                <div class="apple-container">
                    <div class="apple"></div>
        ...
        <div class="choices">
            <div class="draggable" draggable="true">16</div>
            <div class="draggable" draggable="true">20</div>
        </div>
...
<script src="Java Script/exercise4-4.js"></script>
</body>
</html>
