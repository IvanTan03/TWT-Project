...
<head>
    ...
    <link rel="stylesheet" href="css/exercise3-5.css">
...
<div class="back-button" onclick="window.history.back()">
    ...
    <div class="container">
        <div class="question" id="question1">
            <div class="border-box">
                ...
                <img src="./Image/circle.png" alt="circle" class="shape">
                <button class="answer" data-answer="circle">circle</button>
                <button class="answer" data-answer="square">square</button>
        ...
        <div class="question" id="question2" style="display: none;">
            <div class="border-box">
                <p>What shape is this?</p>
                <img src="./Image/square.png" alt="square" class="shape">
                <button class="answer" data-answer="circle">circle</button>
                <button class="answer" data-answer="square">square</button>
                <button id="done-button" class="done-button">Done</button>
            </div>
        ...
        <div class="question" id="question3" style="display: none;">
            <div class="border-box">
                <p>What shape is this?</p>
                <img src="./Image/triangle.png" alt="triangle" class="shape">
                <button class="answer" data-answer="circle">circle</button>
                <button class="answer" data-answer="triangle">triangle</button>
                <button id="done-button" class="done-button">Done</button>
            </div>
        </div>
    </div>
    ...
    <script src="Java Script/exercise3-5.js"></script>
</body>
</html>
