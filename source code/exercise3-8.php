...
<head>
    ...
    <link rel="stylesheet" href="css/exercise3-8.css">
    <script src="Java Script/exercise3-8.js"></script>
...
<div class="back-button" onclick="window.history.back()">
    ...
    <div class="container">
        ...
        <div class="question">
            ...
            <div class="options">
                <div class="option" draggable="true" id="1">1</div>
                <div class="option" draggable="true" id="2">2</div>
                <div class="option" draggable="true" id="4">4</div>
                <div class="option" draggable="true" id="5">5</div>
                <div class="option" draggable="true" id="6">6</div>
            </div>
