...
<head>
    ...
    <link rel="stylesheet" href="css/exercise3-9.css">
        ...
        <div class="question">
            <div class="apples">
                ...
                <div class="apple-container">
                    <div class="apple"></div>
                    <div class="numbers">
                    <div class="dropzone" data-number="5"></div>
                    </div>
                </div>
                <div class="apple-container">
                    <div class="apple"></div>
                ...
                <div class="apple-container">
                    <div class="apple"></div>
                    <div class="numbers">
                    <div class="dropzone" data-number="7"></div>
                    </div>
                </div>
                <div class="apple-container">
                    <div class="apple"></div>
        ...
        <div class="question">
            <div class="apples">
                ...
                <div class="apple-container">
                    <div class="apple"></div>
                    <div class="numbers">
                    <div class="dropzone" data-number="2"></div>
                    </div>
                </div>
                <div class="apple-container">
                    <div class="apple"></div>
        ...
        <div class="question">
            <div class="apples">
                ...
                <div class="apple-container">
                    <div class="apple"></div>
                    <div class="numbers">
                    <div class="dropzone" data-number="6"></div>
                    </div>
                </div>
                <div class="apple-container">
                    <div class="apple"></div>
...
<script src="Java Script/exercise3-9.js"></script>
</body>
</html>
