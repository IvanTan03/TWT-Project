...
<head>
    ...
    <link rel="stylesheet" href="css/exercise3-7.css">
...
<div class="back-button" onclick="window.history.back()">
    ...
    <div class="question-container" id="question1">
        <p>1, 2, 3, 4, _</p>
        <button class="option" onclick="checkAnswer(1, 5)">5</button>
        <button class="option" onclick="checkAnswer(1, 4)">4</button>
    </div>

    <div class="question-container" id="question2">
        <p>3, 4, 5, 6, _</p>
        <button class="option" onclick="checkAnswer(2, 10)">10</button>
        <button class="option" onclick="checkAnswer(2, 7)">7</button>
    </div>

    <div class="question-container" id="question3">
        <p>5, 6, 7, 8, _</p>
        <button class="option" onclick="checkAnswer(3, 9)">9</button>
        <button class="option" onclick="checkAnswer(3, 4)">4</button>
    </div>
    ...
    <script src="Java Script/exercise3-7.js"></script>
</body>
</html>
