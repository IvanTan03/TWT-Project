...
<div class="container">
    ...
    <div class="question" id="question1">
        ...
        <div class="choices">
            <button class="choice" onclick="checkAnswer(1, 2)">1</button>
            <button class="choice" onclick="checkAnswer(1, 2)">2</button>
            <button class="choice" onclick="checkAnswer(1, 2)">3</button>
            <button class="choice" onclick="checkAnswer(1, 2)">4</button>
        </div>
    </div>
    ...
    <div class="question" id="question2" style="display: none;">
        ...
        <div class="choices">
            <button class="choice" onclick="checkAnswer(2, 6)">5</button>
            <button class="choice" onclick="checkAnswer(2, 6)">6</button>
            <button class="choice" onclick="checkAnswer(2, 6)">7</button>
            <button class="choice" onclick="checkAnswer(2, 6)">8</button>
        </div>
    </div>
    ...
    <div class="question" id="question3" style="display: none;">
        ...
        <div class="choices">
            <button class="choice" onclick="checkAnswer(3, 10)">9</button>
            <button class="choice" onclick="checkAnswer(3, 10)">10</button>
            <button class="choice" onclick="checkAnswer(3, 10)">11</button>
            <button class="choice" onclick="checkAnswer(3, 10)">12</button>
        </div>
    </div>
    ...
    <script src="Java Script/exercise3-1.js"></script>
</body>
</html>
